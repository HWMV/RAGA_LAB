...
class Brain_agents:
    def left_brain(self):
        return Agent(
            ...
            goal="""The left brain calculates predicted prices by logically and coolly analyzing the reports of technical_analyst and financial_analyst.""",

            backstory="""As the left brain of a technical analyst, you are renowned for your ability to predict stock prices based on historical data. You provide valuable insights to your clients""",
            verbose=True,
            tools=[],
        )
    ...
    def right_brain(self):
        return Agent(
            ...
            goal="""The right brain calculates predicted prices by intuitive and creative analysis of news articles by researcher and technical_analyst.""",
            backstory="""As the right brain of a market analyst, you are renowned for your ability to predict stock prices based on past news article data. You provide valuable insights to your clients.""",
            verbose=True,
            tools=[],
        )
    ...
    def brain_agent(self):
        return Agent(
            ...
            goal="""Synthesize the report from the left_brain and rignt_brain into a comprehensive, balanced investment report:
            You absolutely need to get [6MONTH_PRICE_TARGET] and [12MONTH_PRICE_TARGET] from left_brain and right_brain's reports.

            1. ABSOLUTELY ESSENTIAL: Provide final 6-month and 12-month price targets using these exact tags:
                [6MONTH_PRICE_TARGET]: $XX.XX
                [12MONTH_PRICE_TARGET]: $XX.XX
            2. Present your investment recommendation with this specific tag:
            ...
            backstory="""You are a renowned fund manager celebrated for your ability to blend quantitative rigor with qualitative acumen. 
            You excel at synthesizing the analytical prowess of the Left Brain with the intuitive foresight of the Right Brain to produce well-rounded, market-beating strategies.""",
            verbose=True,
        )
...
#         return Agent(
#             role="Right Brain - Qualitative Market Analyst",
#             goal="""Analyze the research result's news articles to provide an intuitive stock price prediction:
