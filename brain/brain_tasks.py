...
class Brain_tasks:
    def left_brain_task(self, agent, context):
        return Task(
            description="Based on the technical analysis, and financial analysis,  reports, provide a detailed investment recommendation for {company}'s stock. Include your analysis of the stock's potential risks and rewards, and provide a clear rationale for your recommendation.",
            expected_output=f"""Your final answer MUST be a detailed investment recommendation report to BUY or SELL the stock that includes your analysis of the stock's potential risks and rewards. 
            Provide a clear rationale for your recommendation based on the research, technical analysis, and financial analysis reports.
            - [INVESTMENT_RECOMMENDATION]Final investment recommendation: [Buy/Hold/Sell] (Confidence: [Low/Medium/High])
            - [6MONTH_PRICE_TARGET]Consolidated 6-month price target: $XX.XX
            - [12MONTH_PRICE_TARGET]Consolidated 12-month price target: $XX.XX
            [6MONTH_PRICE_TAGET],[12MONTH_PRICE_TAGET] must be output in this format.""",
            agent=agent,
            context=context,
    ...
    def right_brain_task(self, agent, context):
        return Task(
            description="""Based on the research, technical analysis,  reports, provide a detailed investment recommendation for {company}'s stock. Provide a clear rationale for your recommendation, including an analysis of the potential risks and rewards based on market analysis of news articles about the stock.
            Provide your answer based on an intuitive and creative analysis method.""",
            expected_output=f"""Your final answer MUST be a detailed investment recommendation report to BUY or SELL the stock that includes your analysis of the stock's potential risks and rewards. 
            Provide a clear rationale for your recommendation based on the research, technical analysis, and financial analysis reports.
            - [INVESTMENT_RECOMMENDATION]Final investment recommendation: [Buy/Hold/Sell] (Confidence: [Low/Medium/High])
            - [6MONTH_PRICE_TARGET]Consolidated 6-month price target: $XX.XX
    ...
    def brain_agent_task(self, agent, context):
        return Task(
            description=f"""Synthesize a comprehensive investment recommendation report for [{context}=left_brain_task, right_brain_task]:
            1. Review and summarize the Left Brain (quantitative) analysis.
            2. Review and summarize the Right Brain (qualitative) analysis.
            3. You must include [6MONTH_PRICE_TARGET], [12MONTH_PRICE_TARGET] of left_brain_task, right_brain_task.
            4. Integrate both analyses, reconciling any discrepancies.
            5. Provide a final conclusion with 6-month and 12-month price targets and an investment recommendation.
