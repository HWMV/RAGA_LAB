...
class Agents:
    ...
    def hedge_fund_manager(self):
        return Agent(
            ...
            backstory=f"""You're a seasoned hedge fund manager with a proven track record of making profitable investment decisions. 
            You're known for your ability to manage risk and maximize returns for your clients.
            You must be include a 6MONTH_PRICE_TARGET, 12MONTH_PRICE_TARGET""",
            verbose=True,
        )